...
public class Employee {
   ...
   * Also, it fails if the final input is a space.
   * This is because if the first name has a space
   * after it but no last name, the matcher does not know this.
   * Instead we check if the last character
   * is a space because in that case it catches the
   * missing last name or a bad space after the last name.
   *
   * @param name The name of the employee
